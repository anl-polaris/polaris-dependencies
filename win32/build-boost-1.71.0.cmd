...
IF NOT EXIST %BOOSTZIPFILE% (
	set ERRORLEVEL=
	cd /D %BASEDIR%
	%~dp0utils\wget --show-progress=off -O %BOOSTZIPFILE% "https://boostorg.jfrog.io/artifactory/main/release/1.71.0/source/boost_1_71_0.zip"
...
iF NOT EXIST %BOOSTDIR% (
	%~dp0utils\7-Zip\7z x %BOOSTZIPFILE%
